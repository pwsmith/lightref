...
var techreportCmd = &cobra.Command{
	Use:   "techreport",
	Short: "Adds a techreport to the bibiliography",
	Long: `The techreport command asks for the following fields:
    - citekey
    - author
    - title
    - institution
	...
	Run: func(cmd *cobra.Command, args []string) {
		bibinfo.AddTechReport()
	},
}

func init() {
	addCmd.AddCommand(techreportCmd)
